import React from 'react';
 import img1 from './img/rgslogo.png';
 import img2 from './img/rgslogo.png';
        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                   <img  className="w-20 h-9 mx-6  dark:hidden"
                  src={img1}
                  alt="logo"
                  width={140}
                  height={50}
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                <Link
                  href="/search"
                  className=" py-3 px-7 text-base font-bold text-white hover:opacity-70 dark:text-white md:block"
                >
                  <img className="h-6  " src="rgs-img/search-nav.png" alt="" />
                </Link>
                {/* <Link
                  href="/contact"
...
<Link to="/contact" className="py-6 px-7 inline-block mx-20  bg-[#00ffff] my-1">
              Contact Us
            </Link>
                <div>
                  {/* <ThemeToggler /> */}
